...
public class SerialActivity extends Activity{
	...
	private static final String[]	m_serialNumber	  = { "ttySAC0", "ttySAC1", "ttySAC2", "ttySAC3" , "ttySAC4"}; 
		...
		{			
			public void onClick(View arg0) 
			{
				...
				else
				{
					...
					mFd = ycapi.openCom(path, m_serialBauteInt[m_SpinnerSerialBaute.getSelectedItemPosition()],
